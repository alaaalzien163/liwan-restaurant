  ...
  return (
    <div className="flex min-h-[300px] items-center justify-center">
      <div className="text-text-tertiary flex flex-col items-center gap-3">
        <Spinner size="lg" />
        <p className="text-sm">{t("categories.states.loading")}</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div>
          <p className="text-text-primary text-lg font-medium">
            {t("categories.states.emptyTitle")}
          </p>
          <p className="text-text-tertiary text-sm">
            {t("categories.states.emptyDescription")}
          </p>
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div>
          <p className="text-text-primary text-lg font-medium">
            {t("categories.states.errorTitle")}
          </p>
          <p className="text-text-tertiary text-sm">
            {message ?? t("categories.states.errorFallback")}
          </p>
        </div>
        {onRetry && (
