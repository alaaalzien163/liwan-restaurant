...
export function LanguageSwitch({
  ...
  return (
    <button
      ...
      className={cn(
        "text-text-secondary hover:bg-surface-tertiary hover:text-text-primary inline-flex items-center gap-1 rounded-lg px-3 py-2 text-sm font-medium transition-colors",
        className,
      )}
